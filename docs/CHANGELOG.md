...
### Fixed
- exclude src/ from release package completeness scope

## [2.1.4] - 2026-09-19

### Fixed
- pass source page and sender name to newsletter subscribe
- report contact submission side effects

## [2.1.3] - 2026-07-12

### Changed
- migrate to extrachill_network_subscribe (#8)
...
### Fixed
- sync block.json version on release so style/script changes bust caches
